...
Вторая иконка модуля **NGQ Rosreestr Tools** |icon_add_layers| позволяет добавлять различные слои данных Росреестра (см. :numref:`add_layers_pkk`) из Национальной системы пространственных данных (далее - НСПД):
...
Добавлять слои данных  Росреестра из НСПД так же можно через Панель “Браузер”.
...
.. figure:: _static/add_layer_ppk_ru.png
   ...
   Добавление слоёв из НСПД через панель "Браузер"
